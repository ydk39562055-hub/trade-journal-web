...
☐ 동시 포지션 1개 — 복수매매 금지`;
  ...
  // ⚠ at 형식은 내가 직접 쓴 메모와 똑같이 'YYYY-MM-DD HH:MM'(우리 시간) 이어야 한다.
  //    ISO(...T..Z)로 두면 달력이 세계표준시 날짜에 점을 찍어 하루 어긋나고, 시간이 '22:14:00Z'로 나온다.
  const MEMOS = [
    { id: 'memo-seed-1', at: '2026-07-29 07:14', text: '⚠ 실수 — 추격\n스윕 안 기다리고 OB 보고 바로 진입. 매크로 윈도우도 벗어났었다. 다음엔 킬존 + 스윕 확인까지 무조건 기다린다.' },
    { id: 'memo-seed-2', at: '2026-07-25 22:03', text: '⚠ 실수 — 손절 밀기\n손절을 살짝 옮겼다가 더 크게 맞음. 손절은 진입과 동시에 고정, 절대 불리하게 이동 금지.' },
    { id: 'memo-seed-3', at: '2026-07-21 18:40', text: '⚠ 실수 — 복수매매\n직전 손실 복구하려고 바로 재진입. 복수매매 금지 룰 어김. 진 날은 화면을 끈다.' },
    { id: 'memo-seed-4', at: '2026-07-18 21:20', text: '⚠ 실수 — 오버사이즈\n자리 좋아 보여서 사이즈를 키움. 결과는 손실이라 더 아팠다. 리스크 0.5~1% 고정으로 돌아간다.' },
    { id: 'memo-seed-5', at: '2026-07-14 17:55', text: '⚠ 실수 — 포모\n남들 다 먹는 것 같아 뒤늦게 추격. 계획에 없던 진입. 내 셋업 아니면 그냥 본다.' },
  ];
