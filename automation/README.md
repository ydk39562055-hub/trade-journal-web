...
2026-09-09 추가: FP Markets 실사용 조회 전용 연결, 올해 체결 수집, 별도 클라우드 동기화와 PC 5분 자동 실행을 구현·검증했다. [FP Markets 운영 안내](ctrader/README.md)를 참고한다. 아래 9월 6일 기록의 FP 승인 대기는 해소됐다.
